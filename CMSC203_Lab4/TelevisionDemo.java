...
public class TelevisionDemo
	...
	public static void main(String[] args)
	{
		...
		//Declaring another Television object called portable
		...
		//Use calls to the mutator methods to change the channel to the user’s preference and decrease +
		//the volume by two.
		System.out.print("What channel do you want?");
		station = keyboard.nextInt();
		...
		System.out.println("Programmer: Belinda Nguyen");
